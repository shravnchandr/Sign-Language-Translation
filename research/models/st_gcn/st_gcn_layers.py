...
class ST_GCN_Block(nn.Module):
    ...
    def __init__(
        ...
        self.tcn = TemporalConvolution(
            out_channels, out_channels, kernel_size=temporal_kernel_size, stride=stride
        )
...
class MultiScaleST_GCN_Block(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, adj_matrix):
        ...
        self.tcn_short = TemporalConvolution(
            out_channels, scale_channels, kernel_size=3
        )
        self.tcn_medium = TemporalConvolution(
            out_channels, scale_channels, kernel_size=9
        )
        self.tcn_long = TemporalConvolution(
            out_channels, scale_channels, kernel_size=15
        )
